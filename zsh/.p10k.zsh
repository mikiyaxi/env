# Generated by Powerlevel10k configuration wizard on 2022-10-11 at 16:07 EDT.
...
() {
  ...
  # Icon color.
  # ===============================================================
  # if you want to remove git icon before cat icon of git, set the below variable equal to nothing
